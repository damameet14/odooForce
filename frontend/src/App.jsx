...
function Shell() {
  ...
  return <div className="shell">
    <aside className={open ? "open" : ""}>
      <div className="brand"><img src="/odoo-force-logo.png" alt="OdooForce" className="brand-logo" /><div><strong>OdooForce</strong><small>Procurement ERP</small></div><button className="mobile-close" onClick={() => setOpen(false)}><X size={18} /></button></div>
